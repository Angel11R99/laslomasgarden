...
<head>
  ...
  <style>
    :root {
      ...
      --lls-ink: #335f62;
      --lls-copy: #6f8688;
      --lls-emerald-900: #0b4f44;
      --lls-emerald-800: #0d6758;
      --lls-emerald-700: #12927d;
      --lls-emerald-600: #19a98d;
      --lls-hero-line: #5cb9cc;
      --lls-gold-100: #f6e9c9;
      --lls-shell: 1240px;
      --lls-content: 1120px;
    }
  ...
  <script>
    (function () {
      ...
      function updateHeaderGlass() {
        ...
        var isCompact = window.scrollY > 70 && !isMobile;
    ...
    <div class="lls-footer-inner">
      ...
      <section class="lls-footer-follow" aria-label="Follow us links">
        ...
        <div class="lls-social-row">
          <a class="lls-social-link" href="https://wa.me/" aria-label="WhatsApp" target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24">
              <path d="M20 12a8 8 0 0 1-11.8 7l-3.2 1 1-3.1A8 8 0 1 1 20 12z"></path>
              <path
                d="M9.2 9.4c.3-.7.6-.7.9-.7h.5c.2 0 .4 0 .6.4.2.4.7 1.5.7 1.6.1.1.1.3 0 .4l-.3.5c-.1.1-.2.2-.1.4.1.2.4.7 1 1.1.7.6 1.4.8 1.6.9.2.1.3 0 .4-.1l.5-.5c.1-.1.3-.2.4-.1.2.1 1.2.6 1.4.8.2.1.3.2.3.4 0 .2-.1.9-.6 1.2-.5.4-1.1.4-1.3.3-.2 0-2-.7-3.4-2-1.6-1.5-2.1-3-2.3-3.3-.2-.3-.2-.7 0-1z">
              </path>
            </svg>
          </a>
          <a class="lls-social-link" href="https://www.instagram.com" aria-label="Instagram" target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24">
          ...
          <a class="lls-social-link lls-social-facebook" href="https://www.facebook.com" aria-label="Facebook"
            target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24">
              <path d="M15 8h-2c-.7 0-1 .3-1 1v2h3l-.3 3H12v6h-3v-6H7v-3h2V8.9c0-2.3 1.3-3.9 3.9-3.9H15v3z"></path>
            </svg>
          </a>
          <a class="lls-social-link lls-social-x" href="https://x.com" aria-label="X" target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24">
              <path d="M4 4l6.5 8.4L4.6 20H7l4.7-5.4L15.9 20H20l-6.8-8.8L19.5 4h-2.4l-4 4.7L9.6 4H4z"></path>
            </svg>
          </a>
        </div>
      </section>
