...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .ric-breakeven__row strong {
      color: #b7770d;
    }

    .ric-breakeven__row.ric-annual strong {
      color: var(--lls-green-700);
    }

    /* Net value color states */
    .lls-summary-monthly-val.ric-pos {
      color: var(--lls-green-800);
    }

    .lls-summary-monthly-val.ric-neg {
      color: #c0392b;
    }

    .lls-summary-monthly-val.ric-neutral {
      color: var(--lls-copy);
    }
    ...
    /* ── Increase font sizes in calculator section ── */
    .lls-calc-section .lls-calc-field label {
      font-size: 1.2rem;
    }

    .lls-calc-section [data-i18n="disclaimer"] {
      font-size: 0.9rem;
    }

    .lls-calc-section .lls-summary-label {
      font-size: 1.2rem;
    }

    .lls-calc-section .ric-exp-row {
      font-size: 1.2rem;
    }

    .lls-calc-section .ric-breakeven__title {
      font-size: 0.9rem;
    }

    .lls-calc-section .lls-summary-foot {
      font-size: 1.2rem;
    }

    .lls-calc-section .lls-calc-form h3 {
      font-size: 1.8rem;
    }
  </style>
</head>
  ...
  <main class="lls-page">
    ...
    <section class="lls-safety">
      <div class="welcome_container">
        <img src="img/home/welcome.webp" alt="" srcset="">
      </div>
    ...
    <section class="lls-intro-bar">
      <div class="lls-shell" style="width: 100%; padding-left: 60px; padding-right: 60px;">
    ...
    <section class="lls-lifestyle-new" style="padding-top:0px">
      <div class="lls-lifestyle-new__text">
        <h2>3-Bedroom Condominiums</h2>
        <p>Beautiful ocean and garden view, this 3-bedroom condo offers a comfortable, modern, and welcoming atmosphere,
          with bright open spaces and a perfect view to enjoy tranquility and comfort.</p>
        <a style="margin-top: 24px;" href="3-bedrooms" class="lls-button">See More</a>
      </div>
      <div class="">
        <img src="img/home/3bed.webp" class="image_full" alt="Project amenities sports court" loading="lazy">

      </div>
    </section>

    <section class="lls-lifestyle-new" style="padding:0px">
      <div class="lls-lifestyle-new__text">
        <h2>2-Bedroom Condominiums</h2>
        <p>Beautiful ocean and garden view, this 2-bedroom condo offers a cozy, modern, and practical atmosphere, with
          well-designed spaces and the perfect view to enjoy peace and comfort.</p>
        <a style="margin-top: 24px;" href="2-bedrooms" class="lls-button">See More</a>
      </div>
      <div class="">
        <img src="img/home/2bed.webp" class="image_full" alt="Project amenities sports court" loading="lazy">
    ...
    <section class="lls-lifestyle-new" style="padding-top:0px">
      ...
      <div class="">
        <img src="img/home/pool-family.webp" class="image_full" alt="Project amenities sports court" loading="lazy">
    ...
    <div class="lls-calc-header">
      <div class="lls-shell">
        <h2 class="lls-calc-title">Investment Calculator<br><span
            style="font-size:0.58em; font-weight:500; letter-spacing:0.03em; color:var(--lls-copy); margin: 0px;">Rental
            Income
            Estimator</span></h2>
      </div>
    </div>
        ...
        <div class="lls-calc-grid">
          ...
          <div class="lls-calc-form">
            ...
            <div class="ric-currency-wrap">
              ...
              <div class="ric-currency-sel">
                <button class="ric-currency-btn ric-curr-active" id="ric-btn-usd" onclick="ricSetCurrency('USD')"
                  title="USD – US Dollar">
                  <img src="https://flagcdn.com/us.svg" alt="US Dollar" width="32" height="22"
                    style="border-radius:3px;display:block;">
                </button>
                <button class="ric-currency-btn" id="ric-btn-dop" onclick="ricSetCurrency('DOP')"
                  title="DOP – Dominican Peso">
                  <img src="https://flagcdn.com/do.svg" alt="Dominican Peso" width="32" height="22"
                    style="border-radius:3px;display:block;">
                </button>
              </div>
            </div>
            ...
            <div class="lls-calc-field">
              ...
              <div class="lls-calc-input-wrap">
                <input type="number" id="ric-nights" placeholder="0" min="1" max="30" step="1"
                  style="padding-left:0.2rem;">
              </div>
            </div>

            <div class="lls-calc-field">
              <label><span data-i18n="labelMortgage">Monthly Mortgage Payment</span> <span
                  style="font-weight:400; font-size:0.85em; color:var(--lls-copy);"
                  data-i18n="labelMortgageOpt">(optional)</span></label>
              <div class="lls-calc-input-wrap">
            ...
            <p data-i18n="disclaimer"
              style="font-size:0.75rem; color:var(--lls-copy); font-style:italic; line-height:1.5; margin-top:1rem;">
              &#9888; All figures are estimates based on market assumptions. Actual results may vary depending on
              occupancy, pricing, operating costs, taxes, and other factors.</p>
          </div>
          ...
          <aside class="lls-calc-summary">
            ...
            <div class="ric-exp-list">
              <div class="ric-exp-row"><span data-i18n="hoaLabel">HOA (fixed)</span><span class="ric-red"
                  id="ric-hoa">$200.00</span></div>
              <div class="ric-exp-row"><span data-i18n="utilitiesLabel">Utilities (est.)</span><span class="ric-red"
                  id="ric-utils">—</span></div>
              <div class="ric-exp-row"><span data-i18n="cleaningLabel">Cleaning (est.)</span><span class="ric-red"
                  id="ric-clean">—</span></div>
              <div class="ric-exp-row"><span data-i18n="platformLabel">Other / Platform (5%)</span><span class="ric-red"
                  id="ric-other">—</span></div>
              <div class="ric-exp-row ric-exp-total"><span data-i18n="totalExpenses">Total Monthly Expenses</span><span
                  class="ric-red" id="ric-total-exp">—</span></div>
            </div>
            ...
            <p id="ric-net-status"
              style="font-size:1.1rem; font-weight:700; font-style:italic; text-align:center; margin: -0.4rem 0 1.4rem; color:var(--lls-green-600);">
            </p>

            <button class="lls-button" style="width:100%" onclick="window.location='/contact-us'"
              data-i18n="btnRequest">REQUEST INFORMATION</button>
            ...
            <div class="ric-breakeven">
              ...
              <div class="ric-breakeven__row ric-annual"
                style="border-top:1px solid #d4e8dd; margin-top:0.5rem; padding-top:0.5rem;">
                <span data-i18n="netAnnual">Net Annual Income (est.)</span>
                <strong id="ric-net-annual">—</strong>
              </div>
            </div>

            <p class="lls-summary-foot" data-i18n="footNote">* These amounts are estimates and are subject to change
              without notice.</p>
          </aside>
