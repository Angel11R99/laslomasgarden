...
<head>
  ...
  <title>Vista Lomas | 3 Bedrooms</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .rooms-hero {
      height: 90vh;
      min-height: 500px;
      background-image: url("img/3-bedrooms/3habitaciones-hero.webp");
    ...
    <div class="rooms-sections">
      ...
      <div class="room-card">
        <figure class="room-card-media">
          <img src="img/3-bedrooms/LivingRoom-3b.webp" alt="Warm and relaxing living room" decoding="async">
        </figure>
      ...
      <div class="room-card">
        <figure class="room-card-media">
          <img src="img/3-bedrooms/Kitchen-3b.webp" alt="Contemporary kitchen" loading="lazy" decoding="async">
        </figure>
        <div class="room-card-copy">
          <h2>Contemporary Kitchens Designed for Everyday Living</h2>
          <p>The kitchens in Vista Lomas are designed to combine functionality with elevated design and high-quality materials. Thoughtfully planned layouts and refined finishes make preparing and serving meals both effortless and enjoyable.</p>
          <div class="rooms-actions">
            <a class="rooms-button is-solid" href="/contact-us">Request Information</a>
            <a class="rooms-button is-outline" href="/contact-us">Contact US</a>
          </div>
      ...
      <div class="room-card">
        <figure class="room-card-media">
          <img src="img/3-bedrooms/BedRoom-3b.webp" alt="Comfortable modern bedroom" loading="lazy" decoding="async">
        </figure>
        <div class="room-card-copy">
          <h2>Comfortable &amp; Modern Bedrooms</h2>
          <p>The bedrooms in Vista Lomas are designed to provide an elevated atmosphere of relaxation and comfort. Each space features clean lines, premium finishes, and carefully selected high-quality materials that enhance both elegance and tranquility.</p>
          <div class="rooms-actions">
            <a class="rooms-button is-solid" href="/contact-us">Request Information</a>
            <a class="rooms-button is-outline" href="/contact-us">Contact US</a>
          </div>
      ...
      <div class="room-card">
        <figure class="room-card-media">
          <img src="img/3-bedrooms/gallery/BathRoom-.webp" alt="Clean modern bathroom" loading="lazy" decoding="async">
        </figure>
        <div class="room-card-copy">
      ...
      <div class="room-card">
        <figure class="room-card-media">
          <img src="img/3-bedrooms/gallery/Laundry-5.webp" alt="Laundry area" loading="lazy" decoding="async">
        </figure>
        <div class="room-card-copy">
